...
function GladiatorlosSA:GetSpellList()
	return {
		...
		MAGE = {
			...
			[118]   = { soundName = "polymorph",             durationSound = 0.73, type = "cast"    }, -- Blizzard's Copy past start
			...
			[61305] = { soundName = "polymorph",             durationSound = 0.73, type = "cast"    }, -- Blizzard's Copy past end
